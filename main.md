...
- [Design](#design)
  ...
  - [What Was Changed from the Previous Design](#what-was-changed-from-the-previous-design)
...
**Adam Carbone — Co-Advisor:** Adam Carbone is an electrical engineering student at Cleveland State University and an intern at NASA Glenn Research Center, where he has spent seven semesters contributing to lunar power application projects, progressing from Regenerative Fuel Cell systems to Fission Surface Power, and moving next into 3-phase motor controller design for cryogenic cooling systems on lunar and Martian reactors. He is the founder of Arc Technology, a hardware startup with a product currently launching on Kickstarter, and a co-sponsor of the AWT RoboBots program alongside his brother and fellow advisor, Jack Carbone. As an advisor for AWT RoboBots, Adam contributes across CAD and mechanical design in Autodesk Fusion, custom PCB design and soldering, C# software development, and electrical systems including component selection and device communications. He is committed to giving students the kind of hands-on experience, direct mentorship, and real engineering exposure that sets them up to build, problem-solve, and grow well beyond the classroom. Adam and Jack revived the AWT RoboBots program in 2025 after a multi-year hiatus, growing it from a small remaining group of dedicated students into a thriving organization spanning both high school and middle school teams. For Adam, the program is an investment in the next generation of engineers, and a chance to give students the support, resources, and guidance to do something real.
...
The subsections that follow describe the previous bot in detail, the concrete strengths we preserved and weaknesses we corrected, and the resulting 2026 design with its key stats, CAD renders, and dimensioned engineering drawings.
...
Spinlayden 2.0 was fabricated using three complementary processes across two primary facilities. **Waterjet cutting** of the 1/8" 6061-T6 aluminum hexagonal top and bottom plates was performed on an OMAX 5555 at **Case Western Reserve University's think[box]** makerspace in Cleveland. **CNC milling** of the 3/8" 6061-T6 aluminum perimeter walls and other precision machined parts (bearing mount, gearbox mount) was handled at sponsor **Monode Marking Products** in Mentor, Ohio, under industry advisor J.T. Mackey. **FDM 3D printing** in PLA was done in-house at Riverside High School on printers donated by Show Studio LLC for internal brackets (battery, Pi/IMU), prototype iterations, and the placeholder walls used to validate wiring in parallel with off-site machining. The weapons are six 1/2" zinc-plated carbon steel hex bolts (Everbilt SKU 800980) threaded directly through the chassis walls — one per face — rather than custom-machined blades.

The waterjet session at think[box] ran approximately four hours total. The first hour was spent converting the DXF part files exported from Fusion 360 into the OMAX-compatible ORD format and setting up the job; the remaining three hours were used for cutting and loading, with other makerspace users slotted in between our runs. The OMAX itself ran for roughly one hour of machine time across two nests of two hexagonal plates each, yielding four plates total. No parts needed to be remade. One post-processing adjustment was required: the team manually enlarged several bolt holes after cutting to compensate for the cut face direction selected during waterjet setup. With all major parts fabricated in a single session and no rework required, the team moved efficiently from raw stock to assembled chassis. Detailed step-by-step fabrication procedures, run times, costs, and material justifications are documented in the *Team Procedures → Fabrication* section below.
...
*Figure 8: Spinlayden 2.0 — Alternate isometric view with standard aluminum finish, showing chassis bolt heads, 1/2" carbon steel hex bolt impact weapons threaded through the perimeter walls, and wheel clearance at the chassis corners. CAD: Design Team.*
